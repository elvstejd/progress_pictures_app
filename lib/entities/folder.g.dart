...
void _folderAttach(IsarCollection<dynamic> col, Id id, Folder object) {
  object.id = id;
  object.entries.attach(col, col.isar.collection<Entry>(), r'entries', id);
}
...
extension FolderQueryFilter on QueryBuilder<Folder, Folder, QFilterCondition> {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> titleIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> titleIsNotNull() {
    return QueryBuilder.apply(this, (query) {
...
extension FolderQueryLinks on QueryBuilder<Folder, Folder, QFilterCondition> {
  QueryBuilder<Folder, Folder, QAfterFilterCondition> entries(
      FilterQuery<Entry> q) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterFilterCondition> entriesIsNull() {
    return QueryBuilder.apply(this, (query) {
